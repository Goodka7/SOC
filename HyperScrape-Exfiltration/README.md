...
Under the behavior tab on VirusTotal, we get a little more information about this download:
...
At this point I have enough information based on the Alert and Data that I have found on the EndPoint and Network Logs. I check to make sure no other systems have been infected by this process, and isolate the machine.
